...
#ฟังก๋ชั่นคำนวณผลลัพธ์
def buttonEqual():
    global operator
    result = str(eval(operator)) #eval ใช้คำนวณ+-*/ทั่วไป
...
display_text = Entry(main, font=("arial",20,"bold"),textvariable=input_value,bd=30,
                     insertwidth=4,bg="#fff", justify=RIGHT)

#row0
display_text.grid(columnspan=4)

#สร้าง row1 บน cal เลข 1 7 8 9 +

btn_7 = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="7",command=lambda: buttonClick(7)) #command ส่งค่า
...
btn_plus = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="+",command=lambda: buttonClick("+"))
...
btn_clear = Button(main,padx=16,bd=8,fg="#fff",bg="#3697f5",font=("arial",20,"bold"),text="C",command=buttonClear)
btn_clear.grid(row=4,column=0)

btn_0 = Button(main,padx=16,bd=8,fg="#fff",bg="#000",font=("arial",20,"bold"),text="0",command=lambda: buttonClick(0))
btn_0.grid(row=4,column=1)

btn_equal = Button(main,padx=16,bd=8,fg="#fff",bg="#fe9037",font=("arial",20,"bold"),text="=",command=buttonEqual)
